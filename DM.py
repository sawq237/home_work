...
def pause_toggle():
    global pause
    pause = not pause
    set_status('Пауза' if pause else 'Вперёд!')
...
SPEED = 12
x1, y1 = 50, 50  # red
x2, y2 = x1, y1 + player_size  # blue
player1_color = 'red'
player2_color = 'blue'
x_finish = game_width - 50

window = Tk()
window.title('Догоняй меня, если сможешь!')
...
text_status_id = canvas.create_text(x1, game_height - 50, font=('Arial', 25), text='Беги!')
